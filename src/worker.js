...
const activities = {
  ...
  [OHID_ACTIVITY_TYPE.ADD_INSURANCE_POLICY]: ohidActivities.ohidAddInsurancePolicy,
  [OHID_ACTIVITY_TYPE.ADD_PATIENT_STICKY_NOTE]: ohidActivities.ohidAddPatientStickyNote,
  ...
  ohidAddInsurancePolicy: ohidActivities.ohidAddInsurancePolicy,
  ohidAddPatientStickyNote: ohidActivities.ohidAddPatientStickyNote,
