export const AVAILITY_ACTIVITY_TYPE = {
  PERFORM_LOGIN: "Sign in to Availity",
  POLL_OTP: "Wait for security code",
  SUBMIT_OTP: "Submit security code and finish sign-in",
};

export const OHID_ACTIVITY_TYPE = {
  SIGN_IN: "Sign in to OHID",
  ELIGIBILITY: "Run Medicaid eligibility in OHID",
  PARSE_ELIGIBILITY: "Read eligibility results",
